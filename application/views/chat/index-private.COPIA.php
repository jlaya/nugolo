...
<body style="background-color: #7c298e;">

  <div class="container">
    <div class="row panel-channel">
      <div class="col">
        <div class="table-responsive">
          <div style="float: left;border-style:none;width: 30%;height: 455px;overflow-y: scroll;">
          ...
          <div style="float: left;border-style:none;width: 70%;height: 455px;overflow-y: scroll;">
    ...
    <div class="row panel-group" style="display: none;">
      <div class="col">
          <table border="0" width="30%;border-spacing: 0px;border-collapse: separate;">
            <?php foreach ($channel_group as $key => $value) { ?>
              <tr>
