<div class="icon">
    <a href="#" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0;"><?php echo get_phrase('instructor'); ?></a>
</div>
    ...
    <div class="list-wrapper">
        <div class="item-list">
            <ul>
                ...
                <li style="padding:15px 20px;"><a href="<?php echo site_url('home/instructor/'.$this->session->userdata('user_id')); ?>" style="color: #000000;"><?php echo get_phrase('profile'); ?></a></li>
            </ul>
        </div>
    </div>
</div>
