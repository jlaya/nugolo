...
$my_courses = $this->user_model->my_courses();
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <ul>
                    <li class="active"><a href=""><?php echo get_phrase('all_courses'); ?></a></li>
                    <li><a href="<?php echo site_url('home/mywishlist'); ?>"><?php echo get_phrase('wishlists'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-baseline">
            <div class="col-lg-6">
                <div class="my-course-filter-bar filter-box">
                    ...
                    <div class="btn-group">
                        <a href="<?php echo site_url('home/mycourses'); ?>" class="btn reset-btn" disabled><?php echo get_phrase('reset'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="course-box-wrap">
                            <div class="course-box">
                                ...
                                <div class="course-details">
                                    <a href="<?php echo site_url('home/course/'.slugify($course_details['title']).'/'.$my_course['course_id']); ?>"><h5 class="title"><?php echo $course_details['title']; ?></h5></a>
                                    <a href="<?php echo site_url('home/instructor/'.$instructor_details['id']); ?>"><p class="instructors"><?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?></p></a>
                                ...
                                <div class="row" style="padding: 5px;">
                                    <div class="col-md-6">
                                        <a href="<?php echo site_url('home/course/'.slugify($course_details['title']).'/'.$my_course['course_id']); ?>" class="btn textbtn"><?php echo get_phrase('course_detail'); ?></a>
                                    </div>
                                    <div class="col-md-6">
                                         <a href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$my_course['course_id']); ?>" class="btn textbtn"><?php echo get_phrase('start_lesson'); ?></a>
                                    </div>
                                </div>
                            </div>
                    </div>
