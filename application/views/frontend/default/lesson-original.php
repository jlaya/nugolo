...
<div id="myModalLoad" class="modal fade">
  <picture>
    ...
    <img
      ...
      alt="Notify" style="width: 65%;display:block;margin:auto;">
  </picture>
  <a href="<?php echo base_url('home'); ?>">
    <button class="button-preview" style="text-align: center;cursor: pointer;width: 20%;margin: 0 0 0 50%;">Cerrar</button>
  </a>
</div>
