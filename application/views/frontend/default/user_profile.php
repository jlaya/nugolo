                ...
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                <li class="active"><a href="<?php echo site_url('home/profile/users'); ?>"><?php echo get_phrase('profile'); ?></a></li>
                                <li><a href="<?php echo site_url('home/profile/credentials'); ?>"><?php echo get_phrase('account'); ?></a></li>
