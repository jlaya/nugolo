      ...
      /*  */
         ...
         * {margin: 0; padding: 0;}
         ...
         .body-background-image{
            background-image: url(<?php echo base_url('assets/frontend/img/BG.jpg'); ?>);
         }
   ...
   <body class="body-background-image">
      <div id="segundacaja">
         <section class="form-register">
            <!-- multistep form -->
            <form id="msform" method="POST" action="<?php echo base_url('users/add-private'); ?>">
               <!-- progressbar -->
               <ul id="progressbar">
               ...
               <fieldset>
                  ...
                  <select required="" style="width: 100%;margin-top: 1%;padding: 0px 8px;" id="countries" name="countries">
               ...
               <!-- Valoracion I -->
               <fieldset>
                  <input type="hidden" name="type_activity" value="Ninguno">
                  <input type="hidden" name="frequency" value="Ninguno">
                  <input type="hidden" name="schedule" value="Ninguno">
                  <h2 class="fs-title">Valoraci&oacute;n</h2>
                  <select required="" name="gender" style="width: 100%;margin-top: 1%;">
                     <!--<option value="">G&eacute;nero</option>-->
                     <option value="male">Masculino</option>
                     <option value="female">Femenino</option>
                  </select>
                  <input required="" name="age" type="number" placeholder="Edad" style="margin-top: 4%" />
                  <input required="" name="contact" type="text" placeholder="Contacto (correo y/o n&uacute;mero)" />
                  <input required="" name="weighing" type="text" placeholder="Peso (Kg)" />
                  <input required="" name="stature" type="text" placeholder="Estatura (cm)" />
                  <select required="" id="category_id" name="category_id" style="width: 100%;margin-top: 1%;">
                  ...
                  <textarea id="pathology" name="pathology" placeholder="Especifique su patolog&iacute;a" style="width: 100%;margin-top: 1%;"></textarea>
               ...
               <fieldset>
                  ...
                  <div style="background-color: brown;padding: 2%;">
                     Porfavor escoja "si" en pagar para continuar con su proceso de pago.
                  </div>
                  ...
                  <br>
                  <br>
                  <!--<div class="g-recaptcha" data-sitekey="6LfwdMUZAAAAAL9r3YS1tDQuJg4mlGjGFoqXPi1U"></div>-->
                  <input type="button" name="previous" class="previous action-button" value="Anterior" />
                  <input type="submit" class="submit action-button send-register_1" value="Enviar"/>
            </fieldset>
            </form>
         </section>
         <section class="form-register form-register-whatsapp">
            <div style="background-color: brown;padding: 2%;">
