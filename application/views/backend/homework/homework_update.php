...
<body class="page-body" data-url="http://neon.dev">
    ...
    <div class="page-container">
      ...
      <div class="main-content">
        ...
        <br>
        <br>
        <form autocomplete="off" action="<?php echo site_url('admin/homework/update'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="date" name="range_from" class="form-control" value="<?php echo $edit['range_from'] ?>" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="date" name="range_to" class="form-control" value="<?php echo $edit['range_to'] ?>" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="name" name = "name" class="form-control" value="<?php echo $edit['name'] ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="color" id="color" name = "color" class="form-control" value="<?php echo $edit['color'] ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="hidden" name = "url" class="form-control" value="<?php echo $edit['url'] ?>" required>
                    </div>
                </div>
...
<input type="text" id="value_course_id" value="<?php echo $edit['course_id'] ?>">
<?php include 'application/views/backend/includes_bottom.php'; ?>
<script type="text/javascript">
    $( document ).ready(function() {
        var value_course_id = $("#value_course_id").val();
        $("#course_id").val( value_course_id );
    });
</script>
<script type="text/javascript">
    $( document ).ready(function() {
