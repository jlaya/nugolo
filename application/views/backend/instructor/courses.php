<?php
    ...
    //echo "categoria: ".$default_category_id."<br>";
    //echo "categoria: ".$default_sub_category_id."<br>";
    //echo "categoria: ".$default_instructor_id."<br>";
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <form class="" action="<?php echo site_url('admin/courses'); ?>" method="post">
                        <div class="col-md-3">
                            <select class="form-control" id="source" name="category_id"  onchange="ajax_get_sub_category(this.value)">
                        ...
                        <div class="col-md-3" id = "instructor_id_area">
                            <select class="form-control" id="instructor_id" name="instructor_id" disabled="">
                        ...
                        <div class="col-md-3">
                            <button type="submit" class="btn btn-block btn-default btn-lg" name="button"><i class="fa fa-search"></i> Filtrar</button>
                        </div>
                    </form>
                </div>
                <br>
    ...
    function ajax_get_sub_category(category_id) {
        $.ajax({
            ...
            success: function(response)
            {
                ...
                $("#sub_category_id,#instructor_id").prop("disabled", false);
                $("#source,#sub_category_id").attr("required", true);
