<div class="row top-bar">
	<div class="col-md-12 clearfix hidden-xs">
		<h3 style="display: none;" style="float:left; margin:0px;"><?php echo get_settings('system_name');?></h3>
		<a href="<?php echo base_url('home');?>" class="btn btn-default btn-icon" style="margin: 0px 15px;" target="_blank">
