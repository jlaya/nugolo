            ...
            <div class="panel panel-primary" data-collapsed="0">
              <div class="panel-body">
                  <div class="row" style="margin-left: -15px;">
                      <div class="col-md-3">
                          <a href = "<?php echo site_url('announce/new'); ?>" class="btn btn-block btn-info" type="button"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo get_phrase('add_category'); ?></a>
                      </div>
                  </div>
                  <br>
                  <?php 
                    ...
                    <tbody>
                        ...
                        foreach ($obj as $key => $value): ?>
                            <tr>
                              ...
                              <td style="width: 30%;"><?php echo $value->url; ?></td>
                              <td>
                                <a href='<?php echo base_url("announce/edit/".$value->id) ?>'>
                                  <button class="btn btn-info">Editar</button>
                                </a>
                                |
                                <a href='<?php echo base_url("announce/delete/".$value->id) ?>'>
