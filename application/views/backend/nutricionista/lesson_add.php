...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="#" class="active"><?php echo get_phrase('add_lesson'); ?></a> </li>
</ol>
<h2><?php echo $page_title.' '.get_phrase('for').' '.$course_details['title'];?></h2>
<br />
		...
		<div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
				<div class="panel-title">
					<?php echo get_phrase('add_lesson_form'); ?>
				</div>
			</div>
			<div class="panel-body">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo site_url('admin/lessons/'.$course_id.'/add'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="" id="video" style="display: none;">
                          ...
                          <div class="" id = "html5" style="display: none;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('duration'); ?></label>
                                <div class="col-sm-5">
                                    <!-- <input type="text" name = "html5_duration" id = "html5_duration" class="form-control"> -->
