                    ...
                    <form class="" action="<?php echo site_url('admin/system_settings/system_update'); ?>" method="post">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea type="text" rows="5" data-stylesheet-url="<?php echo base_url('assets/backend/css/wysihtml5-color.css');?>" name = "description_acta" class="form-control wysihtml5" required><?php echo get_settings('description_acta'); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Certificado</label>
                                <div class="controls">
                                    <textarea type="text" rows="5" data-stylesheet-url="<?php echo base_url('assets/backend/css/wysihtml5-color.css');?>" name = "description_certificado" class="form-control wysihtml5" required><?php echo get_settings('description_certificado'); ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="controls">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                    <img height="50px" src="<?php echo base_url('assets/backend/logo.png');?>" alt="...">
                                </div>
