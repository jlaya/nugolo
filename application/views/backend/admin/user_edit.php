...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="#" class="active"><?php echo get_phrase('edit_'.$name); ?></a> </li>
</ol>
		...
		<div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
				<div class="panel-title">
					<?php echo get_phrase($name.'_edit_form'); ?>
				</div>
			</div>
			<div class="panel-body">
                <form class="" id="userform" action="<?php echo site_url('admin/users/edit/'.$user_id.$rol_edit); ?>" method="post" enctype="multipart/form-data">
                    <div class="col-md-8">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <div class="col-md-8 col-sm-8 col-xs-8">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Contrase&ntilde;a <span>*</span></label>
                                                <div class="controls">
