                    ...
                    <form class="" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('banner_title'); ?> 1</label>
                                <div class="controls">
                                    <input type="text" name = "banner_title" class="form-control" value="<?php echo get_frontend_settings('banner_title');  ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('banner_sub_title'); ?> 1</label>
                                <div class="controls">
                            ...
                            <!---baners-->
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('banner_title'); ?> 2</label>
                                <div class="controls">
                                    <input type="text" name = "banner_title2" class="form-control" value="<?php echo get_frontend_settings('banner_title2');  ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('banner_sub_title'); ?> 2</label>
                                <div class="controls">
                                    <input type="text" name = "banner_sub_title2" class="form-control" value="<?php echo  get_frontend_settings('banner_sub_title2');?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('banner_title'); ?> 3</label>
                                <div class="controls">
                                    <input type="text" name = "banner_title3" class="form-control" value="<?php echo get_frontend_settings('banner_title3');  ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('banner_sub_title'); ?> 3</label>
                                <div class="controls">
                                    <input type="text" name = "banner_sub_title3" class="form-control" value="<?php echo  get_frontend_settings('banner_sub_title3');?>">
                                </div>
                            </div>
                            <!---finbanners-->
                            <div class="form-group">
                                ...
                                <form action="<?php echo site_url('admin/frontend_settings/banner_image_update'); ?>" class="no-margin" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                                    <img src="<?php echo base_url('uploads/frontend/home-banner2.jpg');?>" alt="...">
                                                </div>
                                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
                                                <div>
                                                    <span class="btn btn-white btn-file">
                                                        <span class="fileinput-new"><?php echo get_phrase('select_image'); ?></span>
                                                        <span class="fileinput-exists"><?php echo get_phrase('change'); ?></span>
                                                        <input type="file" name="banner_image2" accept="image/*">
                                                    </span>
                                                    <a href="#" class="btn btn-orange fileinput-exists" data-dismiss="fileinput"><?php echo get_phrase('remove'); ?></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="controls">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                                    <img src="<?php echo base_url('uploads/frontend/home-banner3.jpg');?>" alt="...">
                                                </div>
                                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
                                                <div>
                                                    <span class="btn btn-white btn-file">
                                                        <span class="fileinput-new"><?php echo get_phrase('select_image'); ?></span>
                                                        <span class="fileinput-exists"><?php echo get_phrase('change'); ?></span>
                                                        <input type="file" name="banner_image3" accept="image/*">
                                                    </span>
                                                    <a href="#" class="btn btn-orange fileinput-exists" data-dismiss="fileinput"><?php echo get_phrase('remove'); ?></a>
                                                </div>
                                            </div>
                            ...
                            <form action="<?php echo site_url('admin/frontend_settings/logo_upload'); ?>" method="post" class="no-margin" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                                <img height="50px" src="<?php echo base_url('assets/frontend/img/logo.png');?>" alt="...">
                                            </div>
                                            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
                                            <div>
                                                <span class="btn btn-white btn-file">
